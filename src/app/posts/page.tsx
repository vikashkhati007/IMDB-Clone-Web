    ...
    <>
      {loading ? (
        ...
        <div className="divcontainer w-full h-screen bg-white flex justify-center items-center">
          <div className="postcontainer shadow-lg border border-opacity-20 w-3/4 h-fit overflow-hidden">
            <div className="itemscontainer flex m-10 gap-10">
              <div className="w-full h-fit overflow-hidden drop-shadow-xl flex gap-10">
                <Image src={`https://image.tmdb.org/t/p/w500/${data.poster_path}`} alt="image not available" className="" width={250} height={200} />
                <div className="border-l-2 h-35">
                </div>
              </div>
