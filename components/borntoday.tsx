...
const Borntoday = () => {
  return (
    ...
    <div className="imagecontainer flex gap-5 w-full">
      ...
      <Image className="rounded-full" src={"/celebrity/selenagomez.jpg"} width={200} height={200} alt="selena"></Image>
      <p>Selena Gomez</p>
      </div>
      <div className="flex flex-col gap-1 justify-center items-center cursor-pointer hover:bg-black hover:opacity-80">
      <Image className="rounded-full" src={"/celebrity/justinebieber.jpg"} width={200} height={200} alt="justine"></Image>
      <p>Justine Bieber</p>
      </div>
      <div className="flex flex-col gap-1 justify-center items-center cursor-pointer hover:bg-black hover:opacity-80">
      <Image className="rounded-full" src={"/celebrity/dualipa.jpg"} width={200} height={200} alt="dualipa"></Image>
      <p>Dua Lipa</p>
      </div>   
      <div className="flex flex-col gap-1 justify-center items-center cursor-pointer hover:bg-black hover:opacity-80">
      <Image className="rounded-full" src={"/celebrity/ZaynMalik.jpg"} width={200} height={200} alt="dualipa"></Image>
      <p>Zayn Malik</p>
      </div>  
      <div className="flex flex-col gap-1 justify-center items-center cursor-pointer hover:bg-black hover:opacity-80">
      <Image className="rounded-full" src={"/celebrity/oliviarodrigo.jpg"} width={200} height={200} alt="dualipa"></Image>
      <p>Olivia Rodrigo</p>
      </div> 
      <div className="flex flex-col gap-1 justify-center items-center cursor-pointer hover:bg-black hover:opacity-80">
      <Image className="rounded-full" src={"/celebrity/lisa.jpg"} width={200} height={200} alt="dualipa"></Image>
      <p>Lisa</p>
      </div> 
    </div>
  </div>
